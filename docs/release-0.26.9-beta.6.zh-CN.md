...
[直接下载 Windows 安装包](https://github.com/sipingme/deepseek-harness-station/releases/download/v0.26.9-beta.6/DeepSeek-Harness-Station-0.26.9-beta.6-x64-Setup.exe)
